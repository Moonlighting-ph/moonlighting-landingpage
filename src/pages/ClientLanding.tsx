...
import { Shield, Heart, Users, Star, DollarSign, Clock, Check, Building, ArrowRight, Moon } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-6 animate-fade-in" style={{ animationDelay: '400ms' }}>
            <div className="space-y-6">
              <div className="bg-accent p-6 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm md:text-base text-muted-foreground hover:text-primary transition-colors">Healthcare Staffing</a></li>
              <li><a href="#" className="text-sm md:text-base text-muted-foreground hover:text-primary transition-colors">Pricing</a></li>
